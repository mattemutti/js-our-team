...
for (let i = 0; i < team.length; i++) {
	...
	const markUp = `<div class="col-4"><div class= "card text-center"><img src="" alt=""> <h3>${memberTeam.name}</h3> <div>${memberTeam.role}</div></div></div>`;
	...
	imgElement.src=`./assets/img/${memberTeam.image}`;
